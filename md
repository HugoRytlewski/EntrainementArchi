Voici la **Note de cadrage** de ton projet (le Smart Parking de Novaria). C'est le document de synthèse parfait qui résume tout ce qu'on a construit ensemble aujourd'hui. 
...
# 📄 NOTE DE CADRAGE : Projet "Smart Parking Novaria"

## 1. Contexte et Objectifs
La ville de Novaria fait face à des problèmes de congestion urbaine liés à la recherche de places de stationnement et souhaite moderniser son infrastructure de paiement.
...
## 3. Acteurs du Projet
* **Sponsor / Maîtrise d'Ouvrage (MOA) :** La Mairie de Novaria (Direction de la Voirie).
